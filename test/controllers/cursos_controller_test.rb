...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { aulas_id: @curso.aulas_id, link: @curso.link, titulo: @curso.titulo } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { aulas_id: @curso.aulas_id, link: @curso.link, titulo: @curso.titulo } }
